...
import { SPACE_NAMES, publicSpacePlan } from './city-public-space-kit.js';
...
export function discoverySignFor(block) {
  const { type, variant } = publicSpacePlan(block);
  return DISCOVERY_SIGNS.find(sign => sign.type === type && sign.variant === variant);
}
