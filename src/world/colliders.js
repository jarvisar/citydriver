// Car collision footprints, recorded by each chunk as plain data in the
// coordinates the car and traffic collide in, so the list crosses from the
// chunk worker and the driving step never reads a mesh. Positions come in as
// the chunk places them: x, and z measured from the chunk's own start.
...
// Rectangle between two points, halfWidth either side of the line.
